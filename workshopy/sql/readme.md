...
> Note: v případě že používáte PostgreSQL musíte místo AUTO_INCREMENT využít GENERATED BY DEFAULT AS IDENTITY neboť Postgres AUTO_INCREMENT nezná!
> Kód by v tomto případě vypadal takto: ```sql
CREATE TABLE movies (
