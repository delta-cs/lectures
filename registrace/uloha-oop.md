...
Dnes hrajeme:
  1   18:00   Sál 1   Duna
  2   20:30   Sál 1   Přijede k nám návštěva
  3   21:00   Sál 2   Vetřelec
...
1. Místa nejsou stejná. V posledních dvou řadách jsou pohodlnější křesla
   a v sále 2 je balkon. Každý druh místa stojí jinak.
2. Zákazníci chtějí slevy. Studenti platí míň, děti mladší šesti let mají
   vstup zdarma a na projekce, které začínají před pátou odpoledne, je sleva
   pro všechny.

Doplň obojí a u rezervace rovnou ukaž, kolik to bude stát.

Konkrétní ceny a slevy si vymysli sám. Rozmysli si taky, co se stane, když na
...
a nabídne. Podle čeho vybere nejlepší čtveřici, když jich je víc, si urči sám
a napiš to do `README`.
...
2. Soubor `README` (stačí textový) a v něm:
   ...
   - na jaké části jsi program rozdělil a proč zrovna takhle,
   - u úrovně 3 taky to, která místa v programu se kvůli ní musela přepsat.
